...
A minimal, fast cell-based terminal I/O library for Zig in the style of [termbox2](https://github.com/termbox/termbox2) and [notcurses](github.com/dankamongmen/notcurses).
